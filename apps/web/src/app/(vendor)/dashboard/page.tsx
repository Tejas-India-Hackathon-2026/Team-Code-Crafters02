...
const CRAFT_CATEGORIES = [
    ...
    { id: 'sketches', label: 'Custom Sketches & Portraits' },
    { id: 'wood_painting', label: 'Wood Painting & Pyrography' },
    { id: 'resin_floral', label: 'Resin & Floral Art' },
    { id: 'crochet_macrame', label: 'Crochet & Macramé Decor' },
    { id: 'candles_wax', label: 'Handmade Candles & Wax Art' },
    { id: 'calligraphy', label: 'Calligraphy & Hand Lettering' },
    { id: 'papercraft', label: 'Papercraft & Origami Art' },
    { id: 'folk_toys', label: 'Folk Toys & Puppetry' },
    { id: 'lippan_art', label: 'Lippan & Mud Mirror Art' },
    ...
    { id: 'leathercraft', label: 'Leathercraft & Footwear' },
    { id: 'jewelry', label: 'Handmade Jewelry & Beadwork' },
    { id: 'stonecraft', label: 'Stone & Marble Inlay Craft' },
    { id: 'painting', label: 'Traditional Painting & Folk Art' },
    { id: 'bamboo', label: 'Bamboo & Cane Craft' },
    { id: 'terracotta', label: 'Terracotta & Clay Art' },
    { id: 'embroidery', label: 'Embroidery & Zardozi' },
    { id: 'glasscraft', label: 'Glass & Mosaic Craft' },
    { id: 'jute_fiber', label: 'Natural Fiber & Jute Craft' },
];
                ...
                <div className="p-8 max-w-md w-full text-center flex flex-col items-center gap-4 bg-white border border-[#E8E2D9] rounded-2xl shadow-card">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-stone-600 mt-1.5 leading-relaxed">
                            Sign in to your artisan account to view products, manage buyer chats, and submit commission proposals.
                        </p>
                    </div>
                    <Link
