...
const CRAFT_CATEGORIES = [
    ...
    { id: 'sketches', label: 'Sketches & Portraits', icon: '✏️' },
    { id: 'wood_painting', label: 'Wood Pyrography', icon: '🪵' },
    { id: 'resin_floral', label: 'Resin & Floral', icon: '🧪' },
    { id: 'crochet_macrame', label: 'Crochet & Macramé', icon: '🧶' },
    { id: 'candles_wax', label: 'Handmade Candles', icon: '🕯️' },
    { id: 'calligraphy', label: 'Calligraphy Scrolls', icon: '📜' },
    { id: 'papercraft', label: 'Papercraft & Origami', icon: '📄' },
    { id: 'folk_toys', label: 'Folk Toys & Puppets', icon: '🪆' },
    { id: 'lippan_art', label: 'Lippan & Mud Art', icon: '🪞' },
    ...
    { id: 'metalcraft', label: 'Metalcraft & Brass', icon: '🪚' },
    { id: 'leathercraft', label: 'Leathercraft', icon: '👜' },
    { id: 'jewelry', label: 'Handmade Jewelry', icon: '💍' },
    { id: 'stonecraft', label: 'Stone & Marble Craft', icon: '🗿' },
    { id: 'painting', label: 'Folk Painting', icon: '🎨' },
    { id: 'bamboo', label: 'Bamboo & Cane', icon: '🎋' },
    { id: 'terracotta', label: 'Terracotta Art', icon: '🪴' },
    { id: 'embroidery', label: 'Embroidery & Zardozi', icon: '🪡' },
    { id: 'glasscraft', label: 'Glass & Mosaic', icon: '✨' },
    { id: 'jute_fiber', label: 'Jute & Coir Craft', icon: '🌿' },
];
    ...
    const fetchReels = async () => {
        ...
        try {
            const { data } = await supabase
                ...
                .select('*, vendor:profiles!verification_reels_vendor_id_fkey(full_name, avatar_url, vendor_verified)')
